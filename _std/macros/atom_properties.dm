...
#define PROP_MOB_CAN_BE_CRANKED(x) x("can_be_cranked", APPLY_ATOM_PROPERTY_SIMPLE, REMOVE_ATOM_PROPERTY_SIMPLE)
...
#define PROP_ATOM_SOUND_PITCH(x) x("sound_pitch", APPLY_ATOM_PROPERTY_SUM, REMOVE_ATOM_PROPERTY_SUM)
