		...
		for(var/obj/item/P in src.contents)
			...
			switch( P.type )
				...
				if (/obj/item/reagent_containers/food/snacks/ingredient/meat/mysterymeat)
					...
					qdel( P )
				if (/obj/item/plant/grain/wheat/durum)
