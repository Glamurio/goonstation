...
/datum/artifact/powercell
	...
	post_setup()
		...
		switch(src.artitype.name)					// noise
			...
			if ("clockwork")
				O.noise = pick('sound/misc/automaton_scratch.ogg', 'sound/misc/automaton_ratchet.ogg', 'sound/effects/steamrelease.ogg', 'sound/misc/clock_tick.ogg', 'sound/machines/windup.ogg')
			else
